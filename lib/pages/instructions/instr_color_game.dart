...
class InstrColorGame extends StatefulWidget {
  const InstrColorGame({super.key});

  @override
  State<InstrColorGame> createState() => _InstrColorGameState();
}

class _InstrColorGameState extends State<InstrColorGame> {
